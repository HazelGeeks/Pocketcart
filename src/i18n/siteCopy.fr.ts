...
export const frSiteCopy: SiteCopy = {
    ...
    hero: {
      ...
      card: {
        header: "Radar prix",
        searchPlaceholder: "Rechercher produits et magasins proches",
        categoryLabel: "PRODUITS FRAIS",
        productName: "Tomates Roma",
        productMeta: "1 lb · 3 magasins proches",
        liveLabel: "ACTIF",
        rows: [
          { store: "Magasin A", price: "$74.20", delta: "-8%", best: false },
          { store: "Magasin B", price: "$69.80", delta: "-12%", best: true },
          { store: "Magasin C", price: "$72.10", delta: "-9%", best: false },
        ],
      ...
      groups: [
        ...
        },
        {
          ...
          links: [
            ...
            { id: "delete-account", label: "Supprimer le compte" },
          ],
        },
      ],
    },
