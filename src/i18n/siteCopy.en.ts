...
export const enSiteCopy: SiteCopy = {
    ...
    hero: {
      ...
      card: {
        header: "Price Radar",
        searchPlaceholder: "Search products and nearby stores",
        categoryLabel: "FRESH PRODUCE",
        productName: "Roma tomatoes",
        productMeta: "1 lb · 3 stores nearby",
        liveLabel: "LIVE",
        rows: [
          { store: "Mart A", price: "$74.20", delta: "-8%", best: false },
          { store: "Mart B", price: "$69.80", delta: "-12%", best: true },
          { store: "Mart C", price: "$72.10", delta: "-9%", best: false },
        ],
